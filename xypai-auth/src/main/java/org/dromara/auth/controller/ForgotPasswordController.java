...
import org.dromara.auth.domain.dto.ResetPasswordDto;
import org.dromara.auth.domain.dto.VerifyCodeDto;
...
public class ForgotPasswordController {
     ...
     * 步骤1：发送短信验证码
     *
     * <p>⚠️ 注意：此步骤复用 {@link SmsController#sendCode(org.dromara.auth.controller.SmsController.SendSmsRequest)}</p>
     * <p>请求示例：</p>
     * <pre>
     * POST /auth/sms/send
     * {
